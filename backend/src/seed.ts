...
const seed = async () => {
  ...
  const supporterData = [
    ...
    { username: 'ÜbersetzungOlga', points: 3200, location: { country: 'Deutschland', state: 'Hamburg', district: 'Hamburg-Mitte',   neighborhood: 'HafenCity'         }, bio: 'Russisch, Polnisch, Deutsch – Übersetzungen und Sprachhilfe für Behördenbriefe.' },
    { username: 'FitnessCoach_Fatima', points: 2600, location: { country: 'Deutschland', state: 'Bayern', district: 'München-Nord', neighborhood: 'Schwabing'        }, bio: 'Personal Training, Yoga und Ernährungsberatung – komme auch zu euch.' },
    { username: 'ElektrikerEduard', points: 1900, location: { country: 'Deutschland', state: 'NRW',    district: 'Köln-Innenstadt', neighborhood: 'Altstadt-Nord'    }, bio: 'Kleine Elektroarbeiten, Lampen anschließen, Sicherungen prüfen – alles sicher und sauber.' },
    { username: 'GrafDesign_Greta', points: 1400, location: { country: 'Deutschland', state: 'Berlin', district: 'Mitte',           neighborhood: 'Alexanderplatz'   }, bio: 'Logo, Flyer, Social-Media-Grafiken – ich gestalte für gute Zwecke gerne kostenlos.' },
    { username: 'BücherBuddy_Britta', points: 900, location: { country: 'Deutschland', state: 'Berlin', district: 'Prenzlauer Berg', neighborhood: 'Kollwitzkiez'    }, bio: 'Vorlesen, Bibliotheksbegleitung, Buchempfehlungen – ich liebe Bücher und teile das gerne.' },
  ]
  ...
  const seekerData = [
    ...
    { username: 'ElternpflegeElfie',   points: 170, location: { country: 'Deutschland', state: 'Berlin',  district: 'Mitte',           neighborhood: 'Tiergarten'        } },
    { username: 'SoloReisendeSandra',  points: 390, location: { country: 'Deutschland', state: 'Hamburg', district: 'Hamburg-Nord',    neighborhood: 'Eppendorf'         } },
    { username: 'HobbyKochHolger',     points: 250, location: { country: 'Deutschland', state: 'Bayern',  district: 'München-Mitte',   neighborhood: 'Maxvorstadt'       } },
    { username: 'SchülerSimon',        points: 120, location: { country: 'Deutschland', state: 'Berlin',  district: 'Friedrichshain',  neighborhood: 'Boxhagener Platz'  } },
    { username: 'RollstuhlRudolf',     points:  80, location: { country: 'Deutschland', state: 'NRW',     district: 'Köln-Innenstadt', neighborhood: 'Altstadt-Süd'      } },
  ]
  ...
  const tasks: TaskSeed[] = [
    ...
    // Zusätzliche offene Tasks
    {
      title:           'Pflegedokumentation ausfüllen – Hilfe gesucht',
      description:     'Ich pflege meinen Vater zu Hause und bin mit dem Papierkram überfordert. Jemand mit Erfahrung im Pflegebereich soll mir beim Ausfüllen der MDK-Formulare helfen.',
      categories:      ['Sozial & Kommunikation', 'Geistig'],
      difficulty:      3, durationMinutes: 90,
      location:        'Berlin-Tiergarten',
      status:          'open',
      createdBy:       seekers[25]._id,
    },
    {
      title:           'Koffer für Flugreise packen und Checkliste erstellen',
      description:     'Ich fliege nächste Woche zum ersten Mal alleine und bin aufgeregt. Ich brauche jemanden der mir beim Packen hilft und erklärt was erlaubt ist.',
      categories:      ['Körperlich', 'Sozial & Kommunikation'],
      difficulty:      1, durationMinutes: 60,
      location:        'Hamburg-Eppendorf',
      status:          'open',
      createdBy:       seekers[26]._id,
    },
    {
      title:           'Kochgrundlagen lernen – Schnelle Alltagsgerichte',
      description:     'Ich lebe allein und kann kaum kochen. Ich möchte 5–6 schnelle Gerichte lernen die ich regelmäßig machen kann. Zutaten stelle ich bereit.',
      categories:      ['Talent & Kreativität', 'Sozial & Kommunikation'],
      difficulty:      2, durationMinutes: 120,
      location:        'München-Maxvorstadt',
      status:          'open',
      createdBy:       seekers[27]._id,
    },
    {
      title:           'Abitur-Vorbereitung Deutsch – Aufsatz und Interpretation',
      description:     'Ich schreibe in 3 Wochen mein Deutschabitur. Mein größtes Problem sind Textinterpretationen und Erörterungen. Suche intensive Lernhilfe.',
      categories:      ['Geistig'],
      difficulty:      4, durationMinutes: 120,
      location:        'Berlin-Friedrichshain',
      status:          'open',
      createdBy:       seekers[28]._id,
    },
    {
      title:           'Rollstuhlrampe aus Holz bauen – kleines Haus',
      description:     'Ich brauche eine stabile Rampe für meinen Hauseingang (3 Stufen). Material ist bestellbar. Jemand mit handwerklichem Geschick und Erfahrung gesucht.',
      categories:      ['Körperlich'],
      difficulty:      4, durationMinutes: 300,
      location:        'Köln-Altstadt-Süd',
      status:          'open',
      createdBy:       seekers[29]._id,
    },
    {
      title:           'LinkedIn-Profil aufpolieren',
      description:     'Mein LinkedIn-Profil ist leer und veraltet. Ich möchte aktiv auf Jobsuche gehen und brauche Hilfe beim Formulieren und Strukturieren meines Profils.',
      categories:      ['Sozial & Kommunikation', 'Geistig'],
      difficulty:      2, durationMinutes: 90,
    ...
    {
      title:           'Bücher sortieren, beschriften und einräumen',
      description:     'Meine Bibliothek ist ein Chaos nach dem Umzug. Ca. 400 Bücher müssen sortiert und eingeräumt werden. Ich habe ein großes Regal, brauche aber Hilfe beim Durcharbeiten.',
      categories:      ['Körperlich', 'Geistig'],
      difficulty:      2, durationMinutes: 180,
      location:        'Berlin-Prenzlauer Berg',
      status:          'open',
    ...
    {
      title:           'Backofen und Herd gründlich reinigen',
      description:     'Mein Backofen ist eingebrannt und der Herd hat hartnäckige Flecken. Reinigungsmittel sind vorhanden. Ich brauche jemanden der mir dabei hilft.',
      categories:      ['Körperlich'],
      difficulty:      2, durationMinutes: 90,
      location:        'Berlin-Mitte',
      status:          'open',
    ...
    },
    {
      ...
      description:     'Ich bin seit zwei Jahren freiberuflich tätig und habe meine Steuern bisher immer aufgeschoben. Jetzt brauche ich dringend Hilfe beim Aufräumen und Einreichen.',
      categories:      ['Geistig', 'Sozial & Kommunikation'],
      difficulty:      4, durationMinutes: 180,
      location:        'München-Glockenbachviertel',
      status:          'open',
    ...
    {
      title:           'Fahrradtour planen – Mehrtagesroute',
      description:     'Ich möchte im Sommer eine 4-Tage-Fahrradtour machen. Jemand mit Tourenerfahrung soll mir bei der Streckenplanung, Ausrüstung und Unterkünften helfen.',
      categories:      ['Körperlich', 'Geistig'],
      difficulty:      2, durationMinutes: 90,
      location:        'Hamburg-HafenCity',
      status:          'open',
    ...
    {
      title:           'Teppich verlegen – 3-Zimmer-Wohnung',
      description:     'Ich habe Teppich für 3 Zimmer gekauft. Er muss zugeschnitten und verlegt werden. Ich habe kein Werkzeug dafür. Jemand der sowas schon gemacht hat gesucht.',
      categories:      ['Körperlich'],
      difficulty:      3, durationMinutes: 240,
      location:        'Köln-Innenstadt',
      status:          'open',
    ...
    // Zusätzliche angenommene Tasks
    {
      title:           'Russischer Brief vom Jobcenter übersetzen',
      description:     'Meine Großmutter hat einen offiziellen Brief auf Russisch bekommen und versteht ihn nicht. Ich brauche jemanden der es auf Deutsch erklärt.',
      categories:      ['Sozial & Kommunikation'],
      difficulty:      2, durationMinutes: 30,
      location:        'Hamburg-HafenCity',
      status:          'assigned',
      createdBy:       seekers[5]._id,
      assignedTo:      supporters[25]._id,
    },
    {
      title:           'Yoga-Einführungsstunde für Anfänger',
      description:     'Ich habe seit Monaten Rückenprobleme und möchte mit Yoga anfangen. Suche eine Einführungsstunde mit professioneller Anleitung.',
      categories:      ['Körperlich', 'Sozial & Kommunikation'],
      difficulty:      1, durationMinutes: 60,
      location:        'München-Schwabing',
      status:          'assigned',
      createdBy:       seekers[4]._id,
      assignedTo:      supporters[26]._id,
    },
    {
      title:           'Lichtschalter und Steckdose austauschen',
      description:     'Ein Lichtschalter im Flur und eine Steckdose im Badezimmer sind defekt. Ich brauche jemanden mit Elektrikerkenntnissen.',
      categories:      ['Körperlich'],
      difficulty:      3, durationMinutes: 60,
      location:        'Köln-Altstadt-Nord',
      status:          'assigned',
      createdBy:       seekers[14]._id,
      assignedTo:      supporters[27]._id,
    },
    {
      title:           'Flyer und Banner für Sportverein gestalten',
      description:     'Unser kleiner Tennisverein braucht frische Werbematerialien – einen A4-Flyer und einen Social-Media-Banner. Kein Budget, aber viel Dankbarkeit.',
      categories:      ['Talent & Kreativität'],
      difficulty:      3, durationMinutes: 120,
      location:        'Berlin-Mitte',
      status:          'assigned',
      createdBy:       seekers[8]._id,
      assignedTo:      supporters[28]._id,
    },

    // Zusätzliche abgeschlossene Tasks
    {
      title:           'Vorlesen für Seniorin – wöchentliche Stunden',
      description:     'Ich bin 82 und kann nicht mehr so gut sehen. Jemand soll mir einmal pro Woche aus Büchern und Zeitungen vorlesen.',
      categories:      ['Sozial & Kommunikation'],
      difficulty:      1, durationMinutes: 60,
      location:        'Berlin-Prenzlauer Berg',
      status:          'done',
      createdBy:       seekers[24]._id,
      assignedTo:      supporters[29]._id,
      completedAt:     new Date('2026-06-02'),
    },
    {
      title:           'Gartenpflege – Rasen mähen und Hecke schneiden',
      description:     'Mein Garten ist seit dem Winter nicht gepflegt worden. Rasen mähen, Hecke schneiden und Laub entsorgen – ca. 3 Stunden Arbeit.',
      categories:      ['Körperlich'],
      difficulty:      2, durationMinutes: 180,
      location:        'München-Schwabing',
      status:          'done',
    ...
    {
      title:           'PC nach Windows-Neuinstallation einrichten',
      description:     'Ich habe meinen PC frisch aufgesetzt. Jetzt müssen Programme installiert, Konten eingerichtet und Daten zurückgespielt werden.',
      categories:      ['Geistig'],
      difficulty:      3, durationMinutes: 90,
      location:        'Bayern-Maxvorstadt',
      status:          'done',
      createdBy:       seekers[1]._id,
      assignedTo:      supporters[0]._id,
    ...
    {
      title:           'Arabisch-Kurs für Fortgeschrittene – Konversation',
      description:     'Ich spreche bereits Grundkenntnisse Arabisch und möchte die Konversation üben. 2 Stunden mit einem Muttersprachler gesucht.',
      categories:      ['Geistig', 'Sozial & Kommunikation'],
      difficulty:      3, durationMinutes: 120,
      location:        'München-Schwabing',
      status:          'done',
  ...
  const offers = [
    ...
    {
      title:           'Fahre Sonntag nach München – Mitfahrer oder Pakete willkommen',
      description:     'Starte Sonntag um 10 Uhr in Berlin Richtung München. 2 Sitzplätze frei. Kann auch kleinere Pakete (bis 15 kg) mitnehmen. Bitte bis Samstag melden.',
      createdBy:       supporters[7]._id,
      categories:      ['Körperlich', 'Sozial & Kommunikation'],
      location:        'Berlin → München',
      offerDate:       new Date('2026-07-06'),
      difficulty:      2,
      durationMinutes: 360,
      pointValue:      720,
      status:          'active',
    ...
    {
      title:           'Russisch-Deutsch Übersetzungshilfe – kostenlos diese Woche',
      description:     'Ich bin Muttersprachlerin und helfe kostenlos bei Briefen, Formularen und Behördendokumenten. Auch Polnisch möglich. Diese Woche verfügbar.',
      createdBy:       supporters[25]._id,
      categories:      ['Sozial & Kommunikation'],
      location:        'Hamburg-HafenCity',
      difficulty:      2,
      durationMinutes: 45,
    ...
    {
      title:           'Kostenlose Yoga-Stunde im Park – jeden Mittwoch',
      description:     'Jeden Mittwoch 18 Uhr im Englischen Garten. Anfänger herzlich willkommen. Matte mitbringen, sonst habe ich ein paar Ersatzmatten dabei.',
      createdBy:       supporters[26]._id,
      categories:      ['Körperlich', 'Sozial & Kommunikation'],
      location:        'München-Schwabing',
      offerDate:       new Date('2026-07-02'),
      difficulty:      1,
    ...
    {
      title:           'Grafik-Design für soziale Projekte – kostenlos',
      description:     'Ich designe kostenlos für soziale Initiativen und Nachbarschaftsprojekte. Logo, Plakat, Flyer – einfach melden und beschreiben was ihr braucht.',
      createdBy:       supporters[28]._id,
      categories:      ['Talent & Kreativität'],
      location:        'Berlin-Alexanderplatz',
      difficulty:      3,
      durationMinutes: 120,
    ...
    {
      title:           'Bewerbungscheck – ich lese eure Unterlagen durch',
      description:     'Ich war 10 Jahre in der HR-Abteilung. Ich schaue mir euer Anschreiben, Lebenslauf und LinkedIn an und gebe konkretes Feedback. Diese Woche bis zu 3 Bewerbungen.',
      createdBy:       supporters[9]._id,
      categories:      ['Sozial & Kommunikation', 'Geistig'],
      location:        'Berlin-Friedrichshain',
      difficulty:      3,
      durationMinutes: 60,
    ...
    {
      title:           'Vorlesen und Gesellschaft für Senioren – ich komme vorbei',
      description:     'Ich besuche gerne ältere Menschen die wenig Besuch haben. Vorlesen, Karten spielen, erzählen – einfach zusammen Zeit verbringen. Meldet euch gerne.',
      createdBy:       supporters[29]._id,
      categories:      ['Sozial & Kommunikation'],
      location:        'Berlin-Prenzlauer Berg',
      difficulty:      1,
      durationMinutes: 90,
    ...
    {
      title:           'Englischkurs für Senioren – 4 Stunden aufgeteilt auf 2 Abende',
      description:     'Habe letzten Monat einen kleinen Engisch-Kurs für eine Gruppe Senioren gegeben. Reiseenglisch, Grundvokabular, Aussprache. War eine tolle Erfahrung!',
      createdBy:       supporters[1]._id,
      categories:      ['Geistig', 'Sozial & Kommunikation'],
      location:        'Berlin-Friedrichshain',
      difficulty:      2,
    ...
    {
      title:           'Gartengeräte verliehen und geholfen – Frühjahrsputz',
      description:     'Habe meine Sense, Harke und Schubkarre verliehen und beim Gartenpflegen mitgeholfen. Schön wenn Nachbarn füreinander da sind!',
      createdBy:       supporters[5]._id,
      categories:      ['Körperlich'],
      location:        'München-Schwabing',
      difficulty:      2,
